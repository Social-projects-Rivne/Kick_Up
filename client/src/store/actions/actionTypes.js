...
export const ADD_ROOMS = 'UPDATE_ROOMS';

// Events
export const STORE_EVENTS = 'STORE_EVENTS';
export const SET_LOADING_EVENTS_STATUS = 'SET_LOADING_EVENTS_STATUS';
export const STORE_EVENT_DETAILS = 'STORE_EVENT_DETAILS';
export const STORE_EVENT_CATEGORIES = 'STORE_EVENT_CATEGORIES';
export const ADD_EVENTS = 'UPDATE_EVENTS';
//userProfile
